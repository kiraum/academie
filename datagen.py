...
async def main():
    ...
    parser = argparse.ArgumentParser(
        description="Datagen - Generate Origin ASN summary per country."
    )
    parser.add_argument(
        "-lg",
        action="store",
        dest="lg",
        metavar="ALICE_URL",
        help="Datagen - Generate Origin ASN summary per country.",
    )
    parser.add_argument(
        "-a",
        action="store_true",
        dest="all",
        help="Generate Origin ASN summary per country.for all IXPS @ datagen/config.yaml.",
    )
